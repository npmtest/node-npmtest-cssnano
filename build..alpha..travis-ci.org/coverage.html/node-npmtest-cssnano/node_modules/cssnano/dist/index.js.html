...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-cssnano/node_modules/cssnano/dist/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-cssnano/node_modules/cssnano/dist/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">90.24% <small>(111 / 123)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">90.16% <small>(110 / 122)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-cssnano/node_modules/cssnano/dist/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.safe === true) {
<span class="cstat-no" title="statement not covered" >        options.isSafe = true;</span>
<span class="cstat-no" title="statement not covered" >        options.safe = null;</span>
    }
&nbsp;
    ...
    var warnings = [];
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof options.fontFamily !== 'undefined' || typeof options.minifyFontWeight !== 'undefined') {
<span class="cstat-no" title="statement not covered" >        warnings.push('The fontFamily &amp; minifyFontWeight options have been ' + 'consolidated into minifyFontValues, and are now deprecated.');</span>
<span class="cstat-no" title="statement not covered" >        if (!options.minifyFontValues) {</span>
<span class="cstat-no" title="statement not covered" >            options.minifyFontValues = options.fontFamily;</span>
        }
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof options.singleCharset !== 'undefined') {
<span class="cstat-no" title="statement not covered" >        warnings.push('The singleCharset option has been renamed to ' + 'normalizeCharset, and is now deprecated.');</span>
<span class="cstat-no" title="statement not covered" >        options.normalizeCharset = options.singleCharset;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (warnings.length) {
<span class="cstat-no" title="statement not covered" >        proc.use(_postcss2.default.plugin('cssnano', <span class="fstat-no" title="function not covered" >function () {</span></span>
...
<span class="cstat-no" title="statement not covered" >                return warnings.forEach(<span class="fstat-no" title="function not covered" >function (w) {</span></span>
<span class="cstat-no" title="statement not covered" >                    return result.warn(w);</span>
                });
            };
        }));
    }
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (opts === false) {
<span class="cstat-no" title="statement not covered" >            opts = { disable: true };</span>
        }
&nbsp;
        opts = (0, _objectAssign2.default)({}, defaultOptions[plugin], safe ? <span class="branch-0 cbranch-no" title="branch not covered" >safeOptions[plugin] </span>: null, opts);
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!opts.disable) {
...
cssnano.process = function (css) {
    var options = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
    options.map = options.map || (options.sourcemap ? <span class="branch-0 cbranch-no" title="branch not covered" >true </span>: null);
